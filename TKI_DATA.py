...
#for y in range (40):
    #if (y==0): 
      #  diff2= 0
     #   to_graph2[str(y)] = diff2
    #else: 
 #       diff2= all_patients_monthlyCon.iloc[1,y]/all_patients_monthlyCon.iloc[0,y-1]
#        to_graph2[str(y)] = diff2
        

#print("Based on Initial")

#graphTrial2= to_graph2.iloc[0,40:]
#print(graphTrial2)

#plt.figure(figsize=(14,9))
#sns.set_palette(sns.color_palette('hls', 7))
#plt.title("Proportion of Participants Discontinue Treatment Over Time (current/initial)", fontsize=30)
#plt.xlabel("Month", fontsize=20)
#plt.ylabel("Discontinuity Rate", fontsize=20)
#plt.xticks(fontsize=12)
#sns.lineplot(data=graphTrial2, sort=False)

#controlProvince=tki_data.loc[(tki_data.Con_ACT == "ALL") & (tki_data.Sex == "ALL") & (tki_data.Age == "ALL")]
#controlProvinceTxE = controlProvince.loc[(controlProvince.Measure=="Tx") | (controlProvince.Measure=="events")]
#x=controlProvinceTxE.groupby('Prov').Measure.sum()
#print(x)